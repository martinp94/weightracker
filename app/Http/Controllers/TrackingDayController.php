...
class TrackingDayController extends Controller
{
     ...
     *
     * @param  int  $tracking_period_id
     * @return \Illuminate\Http\Response
     */
    
    public function show($tracking_period_id, TrackingPeriodService $trackingPeriodService)
    {
        return response()->json(['days' => $trackingPeriodService->days($tracking_period_id)]);
    }
